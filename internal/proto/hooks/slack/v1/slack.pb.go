...
var file_hooks_slack_v1_slack_proto_rawDesc = string([]byte{
...
var (
	...
	file_hooks_slack_v1_slack_proto_rawDescData []byte
)

func file_hooks_slack_v1_slack_proto_rawDescGZIP() []byte {
	file_hooks_slack_v1_slack_proto_rawDescOnce.Do(func() {
		file_hooks_slack_v1_slack_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_hooks_slack_v1_slack_proto_rawDesc), len(file_hooks_slack_v1_slack_proto_rawDesc)))
	})
...
func file_hooks_slack_v1_slack_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_hooks_slack_v1_slack_proto_rawDesc), len(file_hooks_slack_v1_slack_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
