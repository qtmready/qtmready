...
type OrgHooks struct {
	...
	Messaging v1.MessagingHook `protobuf:"varint,2,opt,name=messaging,proto3,enum=ctrlplane.events.v1.MessagingHook" json:"messaging,omitempty"`
}
...
var file_ctrlplane_auth_v1_orgs_proto_rawDesc = []byte{
	...
	0x28, 0x0e, 0x32, 0x22, 0x2e, 0x63, 0x74, 0x72, 0x6c, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x2e, 0x65,
	0x76, 0x65, 0x6e, 0x74, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x69,
...
var file_ctrlplane_auth_v1_orgs_proto_goTypes = []any{
	...
	(v1.MessagingHook)(0),         // 8: ctrlplane.events.v1.MessagingHook
...
var file_ctrlplane_auth_v1_orgs_proto_depIdxs = []int32{
	...
	8,  // 1: ctrlplane.auth.v1.OrgHooks.messaging:type_name -> ctrlplane.events.v1.MessagingHook
