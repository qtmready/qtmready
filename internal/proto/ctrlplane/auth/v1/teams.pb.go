...
var file_ctrlplane_auth_v1_teams_proto_rawDesc = string([]byte{
	...
	0x22, 0xbe, 0x01, 0x0a, 0x04, 0x54, 0x65, 0x61, 0x6d, 0x12, 0x18, 0x0a, 0x02, 0x69, 0x64, 0x18,
	...
	0x67, 0x22, 0x3e, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x54, 0x65, 0x61, 0x6d, 0x52,
	...
	0x64, 0x22, 0x41, 0x0a, 0x12, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x54, 0x65, 0x61, 0x6d, 0x52,
	...
	0x65, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x2e, 0x54, 0x65, 0x61, 0x6d, 0x52, 0x04,
	0x74, 0x65, 0x61, 0x6d, 0x32, 0x68, 0x0a, 0x0b, 0x54, 0x65, 0x61, 0x6d, 0x53, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x12, 0x59, 0x0a, 0x0a, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x54, 0x65, 0x61,
	0x6d, 0x12, 0x24, 0x2e, 0x63, 0x74, 0x72, 0x6c, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x2e, 0x61, 0x75,
	...
	0x74, 0x65, 0x54, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0xc4,
	0x01, 0x0a, 0x15, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x74, 0x72, 0x6c, 0x70, 0x6c, 0x61, 0x6e, 0x65,
	0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x42, 0x0a, 0x54, 0x65, 0x61, 0x6d, 0x73, 0x50,
	0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x39, 0x67, 0x6f, 0x2e, 0x62, 0x72, 0x65, 0x75, 0x2e,
...
var (
	...
	file_ctrlplane_auth_v1_teams_proto_rawDescData []byte
)

func file_ctrlplane_auth_v1_teams_proto_rawDescGZIP() []byte {
	file_ctrlplane_auth_v1_teams_proto_rawDescOnce.Do(func() {
		file_ctrlplane_auth_v1_teams_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_ctrlplane_auth_v1_teams_proto_rawDesc), len(file_ctrlplane_auth_v1_teams_proto_rawDesc)))
	})
...
var file_ctrlplane_auth_v1_teams_proto_depIdxs = []int32{
	3, // 0: ctrlplane.auth.v1.Team.created_at:type_name -> google.protobuf.Timestamp
	3, // 1: ctrlplane.auth.v1.Team.updated_at:type_name -> google.protobuf.Timestamp
	0, // 2: ctrlplane.auth.v1.CreateTeamResponse.team:type_name -> ctrlplane.auth.v1.Team
	1, // 3: ctrlplane.auth.v1.TeamService.CreateTeam:input_type -> ctrlplane.auth.v1.CreateTeamRequest
	2, // 4: ctrlplane.auth.v1.TeamService.CreateTeam:output_type -> ctrlplane.auth.v1.CreateTeamResponse
...
func file_ctrlplane_auth_v1_teams_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_ctrlplane_auth_v1_teams_proto_rawDesc), len(file_ctrlplane_auth_v1_teams_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
