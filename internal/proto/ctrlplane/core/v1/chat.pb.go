...
var file_ctrlplane_core_v1_chat_proto_rawDesc = string([]byte{
...
var (
	...
	file_ctrlplane_core_v1_chat_proto_rawDescData []byte
)

func file_ctrlplane_core_v1_chat_proto_rawDescGZIP() []byte {
	file_ctrlplane_core_v1_chat_proto_rawDescOnce.Do(func() {
		file_ctrlplane_core_v1_chat_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_ctrlplane_core_v1_chat_proto_rawDesc), len(file_ctrlplane_core_v1_chat_proto_rawDesc)))
	})
...
func file_ctrlplane_core_v1_chat_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_ctrlplane_core_v1_chat_proto_rawDesc), len(file_ctrlplane_core_v1_chat_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
