...
// -- required to convert github payloads --
...
type (
	...
	Repository struct {
		...
		ForksCount       db.Int64  `json:"forks_count"`
		MirrorURL        *string   `json:"mirror_url"`
		OpenIssuesCount  db.Int64  `json:"open_issues_count"`
		Forks            db.Int64  `json:"forks"`
		OpenIssues       db.Int64  `json:"open_issues"`
		Watchers         db.Int64  `json:"watchers"`
		DefaultBranch    string    `json:"default_branch"`
		Stargazers       db.Int64  `json:"stargazers"`
	...
	RepositoryPR struct {
		...
		SvnURL           string    `json:"svn_url"`
		Homepage         *string   `json:"homepage"`
		Size             db.Int64  `json:"size"`
		StargazersCount  db.Int64  `json:"stargazers_count"`
		WatchersCount    db.Int64  `json:"watchers_count"`
		Language         *string   `json:"language"`
		HasIssues        bool      `json:"has_issues"`
		HasDownloads     bool      `json:"has_downloads"`
		HasWiki          bool      `json:"has_wiki"`
	...
	MileStone struct {
		...
		OpenIssues   db.Int64  `json:"open_issues"`
		ClosedIssues db.Int64  `json:"closed_issues"`
		CreatedAt    time.Time `json:"created_at"`
		UpdatedAt    time.Time `json:"updated_at"`
	...
	PullRequest struct {
		...
		Comments           db.Int64         `json:"comments"`
		ReviewComments     db.Int64         `json:"review_comments"`
		Commits            db.Int64         `json:"commits"`
		Additions          db.Int64         `json:"additions"`
		Deletions          db.Int64         `json:"deletions"`
		ChangedFiles       db.Int64         `json:"changed_files"`
	}
	...
	WorkflowRunPayload struct {
		...
		WorkflowID         db.Int64       `json:"workflow_id,omitempty"`
		CheckSuiteID       *db.Int64      `json:"check_suite_id,omitempty"`
	...
	PullRequestComment struct {
		ID                  db.Int64  `json:"id,omitempty"`
		NodeID              string    `json:"node_id,omitempty"`
		InReplyTo           *db.Int64 `json:"in_reply_to_id,omitempty"`
		Body                string    `json:"body,omitempty"`
		Path                string    `json:"path,omitempty"`
		DiffHunk            string    `json:"diff_hunk,omitempty"`
		PullRequestReviewID db.Int64  `json:"pull_request_review_id,omitempty"`
		Position            db.Int64  `json:"position,omitempty"`
		OriginalPosition    db.Int64  `json:"original_position,omitempty"`
		StartLine           db.Int64  `json:"start_line,omitempty"`
		Line                db.Int64  `json:"line,omitempty"`
		OriginalLine        db.Int64  `json:"original_line,omitempty"`
		OriginalStartLine   db.Int64  `json:"original_start_line,omitempty"`
