...
const (
	HealthCheckService_Status_FullMethodName = "/ctrlplane.healthz.v1.HealthCheckService/Status"
)
...
type HealthCheckServiceClient interface {
	Status(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*HealthCheckResponse, error)
}
...
func (c *healthCheckServiceClient) Status(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*HealthCheckResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HealthCheckResponse)
	err := c.cc.Invoke(ctx, HealthCheckService_Status_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HealthCheckServiceServer interface {
	Status(context.Context, *emptypb.Empty) (*HealthCheckResponse, error)
}

// UnimplementedHealthCheckServiceServer should be embedded to have
...
func (UnimplementedHealthCheckServiceServer) Status(context.Context, *emptypb.Empty) (*HealthCheckResponse, error) {
...
func _HealthCheckService_Status_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HealthCheckService_Status_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HealthCheckServiceServer).Status(ctx, req.(*emptypb.Empty))
	}
...
var HealthCheckService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ctrlplane.healthz.v1.HealthCheckService",
	...
	Metadata: "ctrlplane/healthz/v1/healthz.proto",
}
