...
const (
	...
	RepoIOSignalPullRequestLabel   shared.WorkflowSignal = "repo_io__pull_request_label"
	RepoIOSignalPullRequestComment shared.WorkflowSignal = "repo_io__pull_request_comment"
