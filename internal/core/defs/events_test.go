...
func (s *EventTestSuite) TestBranchUpdate() {
	branch := &defs.BranchOrTag{
		Ref:           "test-branch",
		DefaultBranch: "main",
	}
...
func (s *EventTestSuite) TestTagCreate() {
...
func (s *EventTestSuite) TestTagDelete() {
	tag := &defs.BranchOrTag{
		Ref:           "v1.0.0",
		DefaultBranch: "main",
	}
...
func (s *EventTestSuite) TestBranchDelete() {
	branch := &defs.BranchOrTag{
		Ref:           "test-branch",
		DefaultBranch: "main",
	}
